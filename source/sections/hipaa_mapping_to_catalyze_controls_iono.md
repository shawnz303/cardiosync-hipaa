# HIPAA Mappings to Iono Controls

Below is a list of HIPAA Safeguards and Requirements and the Iono controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Iono Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Iono Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Iono Control
---------------- | ----------------
